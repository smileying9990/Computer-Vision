...
low_frequencies =  my_filter(image1, filter2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
high_frequencies=image2- my_filter(image2,filter2);
laplacian_filter = [0 1 0; 1 -4 1; 0 1 0];
 
%high_frequencies =  my_filter(image2, laplacian_filter);
%low_frequencies = image1- my_filter(image1, laplacian_filter);
